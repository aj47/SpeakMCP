    ...
    it("should handle internal completion nudge scenario", () => {
      const history: ConversationMessage[] = [
        ...
        },
        {
          role: "user",
          content:
            "If all requested work is complete, call speakmcp-settings:mark_work_complete with a concise summary and then provide the final answer. Otherwise continue working and call more tools.",
          timestamp: 3000,
          ephemeral: true,
        },
      ]

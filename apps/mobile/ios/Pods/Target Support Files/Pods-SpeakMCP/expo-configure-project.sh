...
with_node \
  ...
  --target "/Users/ajjoobandi/Development/SpeakMCP-Workspaces/slot-1/apps/mobile/ios/Pods/Target Support Files/Pods-SpeakMCP/ExpoModulesProvider.swift" \
  --entitlement "/Users/ajjoobandi/Development/SpeakMCP-Workspaces/slot-1/apps/mobile/ios/SpeakMCP/SpeakMCP.entitlements" \
   \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-camera" "expo-constants" "expo-file-system" "expo-font" "expo-keep-awake" "expo-linking" "expo-speech" "expo-speech-recognition"
